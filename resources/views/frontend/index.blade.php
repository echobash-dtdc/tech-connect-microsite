...
@section('content')
  ...
  <section id="hero" class="hero section dark-background">
    <img src="{{ asset('mentor/img/FirstBanner.jpg') }}" alt="" data-aos="fade-in">
    <div class="container">
  ...
  <section id="about" class="about section">
    ...
    <div class="row gy-4">
      ...
      <img src="{{ asset('mentor/img/about.jpg') }}" class="img-fluid" alt="">
      </div>
      ...
      <ul>
        <li><i class="bi bi-check-circle"></i> <span>Ullamco laboris nisi ut aliquip ex ea commodo consequat.</span>
        </li>
        <li><i class="bi bi-check-circle"></i> <span>Duis aute irure dolor in reprehenderit in voluptate velit.</span>
        </li>
  ...
  <section id="courses" class="courses section">
    ...
    <div class="row">
      ...
      <div class="course-item">
        <img src="{{ asset('mentor/img/course-1.jpg') }}" class="img-fluid" alt="...">
      ...
      <div class="course-item">
        <img src="{{ asset('mentor/img/course-2.jpg') }}" class="img-fluid" alt="...">
        <div class="course-content">
        <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <div class="course-item">
        <img src="{{ asset('mentor/img/course-3.jpg') }}" class="img-fluid" alt="...">
        <div class="course-content">
        <div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <section id="trainers-index" class="section trainers-index">
    ...
    <div class="row">
      ...
      <div class="member">
        <img src="{{ asset('mentor/img/team/team-2.jpg') }}" class="img-fluid" alt="">
        <div class="member-content">
        <h4>Sarah Jhinson</h4>
        <span>Marketing</span>
        <p>
      ...
      <div class="member">
        <img src="{{ asset('mentor/img/team/team-3.jpg') }}" class="img-fluid" alt="">
        <div class="member-content">
