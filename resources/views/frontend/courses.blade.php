                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="course-item">
                        ...
                        <div class="course-content">
                            ...
                            <h3><a href="{{ route('frontend.blog') }}">Website Design</a></h3>
                            ...
                            <div class="trainer d-flex justify-content-between align-items-center">
                                <div class="trainer-profile d-flex align-items-center">
                                    ...
                                    <a href="{{ route('frontend.blog') }}" class="trainer-link">Antonio</a>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
                    ...
                    <div class="course-item">
                        ...
                        <div class="course-content">
                            ...
                            <h3><a href="{{ route('frontend.blog') }}">Search Engine Optimization</a></h3>
                            <p class="description">Et architecto provident deleniti facere repellat nobis iste. Id facere
                                quia quae dolores dolorem tempore.</p>
                            <div class="trainer d-flex justify-content-between align-items-center">
                                <div class="trainer-profile d-flex align-items-center">
                                    <img src="{{ asset('mentor/img/trainers/trainer-2-2.jpg') }}" class="img-fluid" alt="">
                                    <a href="{{ route('frontend.blog') }}" class="trainer-link">Lana</a>
                                </div>
                                <div class="trainer-rank d-flex align-items-center">
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in"
                    ...
                    <div class="course-item">
                        ...
                        <div class="course-content">
                            ...
                            <h3><a href="{{ route('frontend.blog') }}">Copywriting</a></h3>
                            <p class="description">Et architecto provident deleniti facere repellat nobis iste. Id facere
                                quia quae dolores dolorem tempore.</p>
                            <div class="trainer d-flex justify-content-between align-items-center">
                                <div class="trainer-profile d-flex align-items-center">
                                    <img src="{{ asset('mentor/img/trainers/trainer-3-2.jpg') }}" class="img-fluid" alt="">
                                    <a href="{{ route('frontend.blog') }}" class="trainer-link">Brandon</a>
                                </div>
                                <div class="trainer-rank d-flex align-items-center">
